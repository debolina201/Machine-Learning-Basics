# -*- coding: utf-8 -*-
"""
Created on Sat Apr 14 23:46:30 2018
...
data2 = pd.read_csv('spam7.csv')
print('First few observations')
data2.head()

data2 = data2.drop('index', axis=1)
number = LabelEncoder()
data2['yesno'] = number.fit_transform(data2['yesno'].astype(str))
print('After preprocessing...')
data2.head()

train2, test2 = train_test_split(data2, test_size=0.2)
pred2 = ['crl.tot', 'dollar', 'bang', 'money', 'n000', 'make']
x_train = train2[pred2].values
y_train = train2['yesno'].values
x_test = test2[pred2].values
y_test = test2['yesno'].values
